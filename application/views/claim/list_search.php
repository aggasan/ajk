		...
		<div class="tabbable-line boxless tabbable-reversed">
			<ul class="nav nav-tabs">
				<li class="active">
					...
					Belum Pernah Klaim </a>
				</li>
				<li>
					<a href="#tab_1" data-toggle="tab">
					Sudah Pernah Klaim </a>
				</li>
			</ul>
			<div class="tab-content">
				<div class="tab-pane active" id="tab_0">
					<form action="<?= site_url('claim/add')?>" method="post">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-docs"></i>Belum Pernah Klaim
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<?php $get_permission = $this->auth->get_permission(343) ?>
							<?php if($get_permission->permission){ ?>
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<input type="submit" name="claim" value="Input Klaim" class="btn blue" onclick="return confirm('Input Klaim?')">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="tab-pane" id="tab_1">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-docs"></i>Sudah Pernah Klaim
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
