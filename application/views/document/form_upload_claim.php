...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		...
		<!-- HIDDEN FOR POST -->
		<input type="hidden" name="claim_id" value="<?= $get_claim->claim_id ?>">
		<!-- HIDDEN FOR POST -->
			<div class="form-body">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="document_name" class="form-control" placeholder="Masukan Text" required="required">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="information" class="form-control" placeholder="Masukan Text" required="required">
							<!-- <span class="help-block">Nama Dokumen</span> -->
						</div>
					</div>
					<!--/span-->	
			...
			<div class="form-actions right">
				<a href="<?= site_url($flag_url_back) ?>" class="btn default" onclick="return confirm('Batal Upload??')"/>Batal</a>
