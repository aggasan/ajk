...
<link href="<?= base_url('theme')?>/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="<?= base_url('theme')?>/assets/admin/layout/img/newlogo.png" height="80" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?= site_url('user/do_login')?>" method="post">
...
<script src="<?= base_url('theme')?>/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="<?= base_url('theme')?>/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
