...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Form Jenis Kredit
		</div>
		<div class="tools">
	...
	<div class="portlet-body form">
		...
		<form action="<?= site_url(uri_string()) ?>" method="post" class="horizontal-form">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="credit_type_name" class="form-control" placeholder="Masukan Jenis Kredit">
			...
			<div class="form-actions right">
				<a href="<?= site_url('creditType') ?>" class="btn default"/>Batal</a>
