...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Form Jenis Perusahaan/Client
		</div>
		<div class="tools">
	...
	<div class="portlet-body form">
		...
		<form action="<?= site_url(uri_string()) ?>" method="post" class="horizontal-form">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="bank_type_name" class="form-control" placeholder="Masukan Jenis Perushaan/Client">
			...
			<div class="form-actions right">
				<a href="<?= site_url('JenisPerusahaan') ?>" class="btn default"/>Batal</a>
